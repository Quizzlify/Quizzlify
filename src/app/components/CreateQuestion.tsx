    ...
    return (
        <div className="bg-secondary w-[1400px] pb-3 rounded-xl border-2 border-orange-600 relative">
            <div className="flex flex-row items-center ml-5 mt-5 gap-3">
                ...
                <Input label="Question" type="input" variant="bordered" size={"sm"} className="max-w-[480px] [&>div]:!border-neutral-500" isRequired />
                <Input label="Nombre de points" type="input" variant="bordered" size={"sm"} className="max-w-[10rem] [&>div]:!border-neutral-500 absolute right-5" isRequired />
            </div>

            <div className="flex flex-col gap-3 ml-20 mt-5">
                <div className="flex flex-row gap-5">
                    <Input label="Réponse A" type="input" variant="bordered" size={"sm"} className="max-w-[480px] [&>div]:!border-neutral-500" isRequired />
                    <Switch color={'warning'}>Réponse vraie</Switch>
                </div>

                <div className="flex flex-row gap-5">
                    <Input label="Réponse B" type="input" variant="bordered" size={"sm"} className="max-w-[480px] [&>div]:!border-neutral-500" isRequired />
                    <Switch color={'warning'}>Réponse vraie</Switch>
                </div>
